...
<div align="center">
  ...
  <p>
    ...
    <a href="ROADMAP.md"><img alt="CYPHES: v0.7.3 testnet" src="https://img.shields.io/badge/CYPHES-v0.7.3_testnet-c7ff47"></a>
    <a href="docs/ATP_IMPLEMENTATION_STATUS.md"><img alt="ATP wire: v0.7.3" src="https://img.shields.io/badge/ATP_wire-v0.7.3-00f6ff"></a>
    <a href="LICENSE"><img alt="License: MIT" src="https://img.shields.io/badge/license-MIT-f5fbfa"></a>
  </p>
</div>

<p align="center">
  <img alt="CYPHES autonomous node cockpit" src="docs/images/CYPHES%20v0.6.2.png" width="100%">
</p>

## Download

The current testnet seed is **CYPHES v0.7.3**. It moves CYPHES from a desktop
...
v0.7.3 starts a fresh isolated testnet with the v0.6.3-v0.6.5 audit and
network liveness hardening, a new ATP wire protocol, a new rendezvous
namespace, and SQLite indexes for the hot pending, credit, and sync queries.
...
- [Download CYPHES v0.7.3](https://github.com/CYPHES-ATP/Node/releases/download/v0.7.3/CYPHES_0.7.3_aarch64.dmg)
- [Download CYPHES v0.7.3 for Intel Macs](https://github.com/CYPHES-ATP/Node/releases/download/v0.7.3/CYPHES_0.7.3_x64.dmg)

Windows download:

- [Download CYPHES v0.7.3 for Windows x64](https://github.com/CYPHES-ATP/Node/releases/download/v0.7.3/CYPHES_0.7.3_x64-setup.exe)
...
- v0.6.5 rebroadcasts signed work-unit claims during network sync so missed
  ...
  settlement.
- v0.7.3 cuts a fresh isolated testnet using `/cyphes/atp/0.7.3` and
  `cyphes.repository-audit.v0.7.3`, defaults every app boot to verifier mode
  until Run is pressed in that session, and adds SQLite indexes for pending queue,
  claim sync, verifier duty, credit summary, and campaign snapshot queries.
