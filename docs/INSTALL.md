...
macOS users can download the current packaged v0.6.5 developer DMGs from:

- Apple Silicon: https://github.com/CYPHES-ATP/Node/releases/download/v0.6.5/CYPHES_0.6.5_aarch64.dmg
- Intel: https://github.com/CYPHES-ATP/Node/releases/download/v0.6.5/CYPHES_0.6.5_x64.dmg
...
The current source tree is v0.6.5. Run from source to test Verified ATP
independent-verifier enforcement, the network liveness hotfixes, the separate
