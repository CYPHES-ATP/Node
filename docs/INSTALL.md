...
macOS users can download the current packaged v0.16.6 Mainnet DMGs from:

- Apple Silicon: https://github.com/CYPHES-ATP/Node/releases/download/v0.16.6/CYPHES_0.16.6_aarch64.dmg
- Intel: https://github.com/CYPHES-ATP/Node/releases/download/v0.16.6/CYPHES_0.16.6_x64.dmg

- Windows x64: https://github.com/CYPHES-ATP/Node/releases/download/v0.16.6/CYPHES_0.16.6_x64-setup.exe
...
The current source tree is v0.16.6. It keeps the
...
v0.16.6 does not require a fresh database; it is a non-mandatory
infrastructure-liveness upgrade with aggregate dashboard summaries, cached
...
recycles silent infrastructure links after 90 seconds. Dial failures are now
visible in telemetry, and the cockpit counts actual active peer links rather
than remembered peers.
