...
Every new paid contribution carries a Cognition Proof packet. v0.16.3 keeps the
...
v0.16.3 keeps the proof-quality gate before settlement. The local audit runtime
...
v0.16.3 also preserves the duplicate/superseded preflight, stays on the
...
v0.16.3 does not change the Cognition Proof wire shape. It improves how the app
...
receipt inspection or worker actions.
